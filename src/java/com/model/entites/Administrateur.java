...
public class Administrateur extends Utilisateur implements Serializable{
    ...
    public Administrateur(String nom, String prenom, String password, String email, String telephone, String photoProfil) {
        super(nom, prenom, password, email, telephone, photoProfil);
    }
